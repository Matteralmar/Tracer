...
urlpatterns = [
    ...
    path('project/management/<int:pk>/completed', ManagementTicketCompletedView.as_view(), name='management-ticket-completed'),
    path('project/management/<int:pk>/reopen', ManagementTicketReopenView.as_view(), name='management-ticket-reopen'),
